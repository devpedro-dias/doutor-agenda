...
import { addAppointment } from "@/src/_actions/add-appointment";
import { getAvailableTimes } from "@/src/_actions/get-available-times";
...
import {
  ...
  PopoverContent,
  PopoverTrigger,
} from "@/src/_components/ui/popover";
import {
  Select,
  SelectContent,
  SelectItem,
                ...
                >
                  ...
                  <SelectContent>
                    {availableTimes?.data?.map((time) => (
                      <SelectItemAdd commentMore actions
                        key={time.value}
                        value={time.value}
